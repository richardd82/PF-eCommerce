...
var arregloDiv = [{div:"div1",img:"img card1",name:"Leandro",apellido:"Bustamente",twiter:"https://twitter.com/Lea_cloud",linkedin:"https://www.linkedin.com/in/leandro-ariel-bustamante-16351923a",git:"https://github.com/Lean-182"}, 
{div:"div2",img:"img card2",name:"Claudio",apellido:"Chumpitaz",twiter:"#",linkedin:"https://www.linkedin.com/in/matias-mogica-113295240/",git:"https://github.com/matiasMogica"}, 
{div:"div3",img:"img card3",name:"Matias",apellido:"Mogica",twiter:"#",linkedin:"#",git:"https://github.com/XDRiderXtremeXD"}, 
{div:"div4",img:"img card4",name:"Ricardo Andrés ",apellido:"Díaz Bautista",
twiter:"https://twitter.com/Richardd82_dev",linkedin:"https://www.linkedin.com/in/richardd82",git:"https://github.com/richardd82"}];
                ...
                {arregloDiv.map((elemento) => {
                    return (
                        ...
                        <div className={"cardAbout"}>
                            ...
                            <h2>{elemento.name}<br /><span>{elemento.apellido}</span></h2>
                            <p className="iconeZoneCard">
                                <a href="https://twitter.com/Richardd82_dev" target="_blank">
                                    <svg height="35" width="35" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 -0 1024 1024" className="iconCard">
                                ...
                                <a href="https://www.linkedin.com/in/richardd82" target="_blank">
                                    <svg height="50" width="40" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 -250 250 800" className="iconCard iconLinkedIn">
                                        <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
                                    </svg>
                                </a>
                                <a href="https://github.com/richardd82" target="_blank">
                                    <svg height="35" width="50" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="-90 0 1024 1024" className="iconCard">
